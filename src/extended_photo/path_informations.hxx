...
namespace ExtendedPhoto
{
    ...
    inline void PathInformations::setPhotographer(const Database::Photographer::Ptr& photographer)
	{
	...
	{
        pDatabase.identifyCameraOwner(input, pPhotographerPtr); // throws if failure
	}
